    ...
    <nav className="bg-red-800 text-white shadow-md relative z-10">
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <div className={`md:flex space-x-6 ${isMobileMenuOpen ? 'flex flex-col absolute top-full right-0 bg-red-800 w-full p-4' : 'hidden'}`}>
          <Link to="/" className="text-white font-normal hover:underline transition duration-300 py-2 px-6 block md:inline-block">Home</Link>
          {!isLoading ? (
            user ? (
              <>
                <Link to="/dashboard" className="text-white font-normal hover:underline transition duration-300 py-2 block md:inline-block">Dashboard</Link>
                <Link to="/settings" className="text-white font-normal hover:underline transition duration-300 py-2 block md:inline-block">Settings</Link>

                <div className="relative">
                  <Link to="/notifications" className="text-white block md:inline-block">
                ...
                <button onClick={handlelogout} className="text-red-800 hover:underline border border-red-800 transition duration-300 bg-white px-4 py-2 font-normal rounded-none focus:outline-none focus:ring-2 focus:ring-red-900 block md:inline-block">Logout</button>
              </>
            ) : (
